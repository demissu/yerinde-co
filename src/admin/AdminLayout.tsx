...
export default function AdminLayout({ title, children, action }: AdminLayoutProps) {
  return (
      ...
      <header className="bg-white border-b border-slate-200">
        <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between gap-4">
          ...
          <nav className="flex items-center gap-3 text-sm">
            ...
            <a href="/admin/atlas" className="text-slate-700 hover:text-slate-950">
              Atlas
            </a>
            <a href="/admin/media" className="text-slate-700 hover:text-slate-950">
              Media
            </a>
